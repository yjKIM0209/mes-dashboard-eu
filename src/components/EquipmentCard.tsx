...
export default function EquipmentCard({ equipment }: EquipmentCardProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md border border-slate-200 hover:shadow-lg transition-all flex flex-col justify-between">
      <div>
        ...
        <div className="space-y-3">
          <div className="flex justify-between text-sm">
            ...
            <span className={`font-semibold ${isHighTemp ? "text-red-500 animate-pulse" : "text-slate-700"}`}>
